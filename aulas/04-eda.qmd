...
<!-- colab-link:start -->
[Abrir no Google Colab](https://colab.research.google.com/github/heitorramos/icd/blob/main/exemplos/04-eda-olist/notebook-colab.ipynb){.btn .btn-outline-primary target="_blank"}
<!-- colab-link:end -->
:::
:::
