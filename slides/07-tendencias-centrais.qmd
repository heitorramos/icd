...
A média populacional $\mu$ permite escrever:

$$
X_i-\bar X=(X_i-\mu)-(\bar X-\mu).
$$

Expandindo os quadrados e usando
...
A dispersão em torno de $\bar X$ é menor: ajustar a média aos próprios dados subtrai o segundo termo.
...
Portanto, $n\sigma^2-\sigma^2=(n-1)\sigma^2$.
