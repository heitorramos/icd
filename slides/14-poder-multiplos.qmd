...
subtitle: "Aula 14 — Detectar efeitos sem fabricar descobertas"
...
![](assets/aula14-poder-multiplos/tamanho-grupos.png){fig-alt="Barras com 44.700 jogadores no gate 30 e 45.489 no gate 40."}
...
![](assets/aula14-poder-multiplos/retencao-observada.png){fig-alt="Barras de retenção em 1 e 7 dias mostrando taxas ligeiramente maiores para a porta no nível 30."}
...
![](assets/aula14-poder-multiplos/rodadas-distribuicao.png){fig-alt="Histograma e boxplots mostrando forte assimetria à direita no número de rodadas."}
...
![](assets/aula14-poder-multiplos/permutacao-h0.png){fig-alt="Distribuição de diferenças por permutação centrada em zero, com a diferença observada na cauda."}
...
![](assets/aula14-poder-multiplos/bootstrap-ha.png){fig-alt="Distribuição bootstrap da diferença de retenção centrada no efeito observado e afastada de zero."}
...
![](assets/aula14-poder-multiplos/bootstrap-h0-recentrado.png){fig-alt="Distribuição bootstrap recentralizada em zero com a diferença observada na cauda."}
...
![](assets/aula14-poder-multiplos/tres-distribuicoes.png){.wide-chart fig-alt="Três histogramas comparando permutação sob H0, bootstrap recentralizado sob H0 e bootstrap usual sob HA."}
...
![](assets/aula14-poder-multiplos/poder-efeito-amostra.png){fig-alt="Curvas de poder para três efeitos e diferentes números de jogadores por grupo."}
...
![](assets/aula14-poder-multiplos/alfa-poder.png){fig-alt="Curva mostrando aumento do poder conforme aumenta o nível de significância."}
...
![](assets/aula14-poder-multiplos/cem-pvalores.png){fig-alt="Cem valores-p sob hipóteses nulas, com alguns abaixo de 0,05 apenas por acaso."}
...
![](assets/aula14-poder-multiplos/fwer-testes.png){fig-alt="Curva crescente da probabilidade de ao menos um falso positivo conforme aumenta o número de testes."}
...
![](assets/aula14-poder-multiplos/bonferroni-bh.png){fig-alt="Valores-p ordenados comparados aos limiares de Bonferroni e Benjamini-Hochberg."}
...
![](assets/aula14-poder-multiplos/winners-curse.png){fig-alt="Distribuições mostrando que efeitos selecionados por significância são maiores que o efeito verdadeiro."}
