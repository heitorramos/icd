...
subtitle: "Aula 09 — Da distribuição amostral ao intervalo de confiança"
...
![](assets/aula09-tcl-inferencia/populacao-entrega.png){fig-alt="Histograma assimétrico à direita do tempo de entrega dos pedidos Olist, com média de 12,6 dias."}
...
![](assets/aula09-tcl-inferencia/amostra-entrega.png){fig-alt="Distribuição populacional do tempo de entrega comparada a um histograma de uma amostra de 50 pedidos."}
...
![](assets/aula09-tcl-inferencia/tcl-tamanhos.png){fig-alt="Distribuições amostrais da média do tempo de entrega para amostras de tamanho 10, 50 e 200."}
...
$\bar{X}$ se aproxima de $\mu$ quando $n$ cresce.
:::

::: {.column width="48%"}
### Teorema Central do Limite

Descreve o formato e a escala da distribuição de $\bar{X}$.
:::
:::
...
![](assets/aula09-tcl-inferencia/tcl-tres-populacoes.png){fig-alt="Populações uniforme, assimétrica e bimodal, com distribuições de médias amostrais aproximadamente normais."}
...
![](assets/aula09-tcl-inferencia/areas-normal.png){fig-alt="Curva Normal dividida em faixas de desvios padrão. A área central até um desvio padrão contém 68,3%, até dois contém 95,4% e até três contém 99,7%."}
...
![](assets/aula09-tcl-inferencia/padronizacao-tcl.png){fig-alt="Histograma das médias padronizadas do tempo de entrega sobreposto à densidade Normal padrão."}
...
![](assets/aula09-tcl-inferencia/erro-padrao-entrega.png){fig-alt="Erro padrão simulado e teórico do tempo médio de entrega em função do tamanho da amostra."}
...
![](assets/aula09-tcl-inferencia/intervalo-exemplo.png){fig-alt="Intervalo de confiança de 95 por cento para o tempo médio de entrega, com a média populacional marcada."}
...
![](assets/aula09-tcl-inferencia/cobertura-intervalos.png){fig-alt="Cem intervalos de confiança simulados, com os que não cobrem a média populacional destacados em laranja."}
...
![](assets/aula09-tcl-inferencia/confianca-largura.png){fig-alt="Barras mostrando intervalos mais largos para níveis de confiança de 80, 90, 95 e 99 por cento."}
...
![](assets/aula09-tcl-inferencia/margem-tamanho.png){fig-alt="Curva decrescente da margem de erro em função do tamanho da amostra."}
...
Na Aula 10, construiremos testes de hipóteses, p-valores e poder estatístico.
