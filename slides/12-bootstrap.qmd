...
- [Para aumentar artificialmente o tamanho da amostra]{data-explanation="Cada réplica continua tendo tamanho n; B controla o número de réplicas, não o tamanho amostral."}
...
- [Aumentar apenas o número de réplicas $B$]{data-explanation="Mais réplicas reduzem erro de Monte Carlo, mas não corrigem a unidade de reamostragem."}
