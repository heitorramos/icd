...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">ICD: Aula 04 — Análise exploratória de dados</span><a class="lecture-footer-button" href="../aulas/04-eda.html">voltar para a Aula</a>'
execute:
  echo: true
---
