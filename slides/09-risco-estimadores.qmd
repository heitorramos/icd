...
Uma mesma estimativa pode surgir por caminhos diferentes. A média amostral é um exemplo.
...
::: {.callout-note title="Exemplo: dados 1, 2 e 3"}
Com perda quadrática simétrica, o ótimo é a média: $a^*=2$.

Se subestimar custa três vezes mais, para $2<a<3$:
...
Logo, $R'(a)=0$ implica $a^*=2{,}4$: o ótimo sobe para evitar a subestimação mais cara.
:::
