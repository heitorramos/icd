...
subtitle: "Aula 13 — Estatísticas, estratos e validade"
...
![](assets/aula12-permutacao/boxplot-exposicoes.png){fig-alt="Boxplots do total de exposições nos grupos, evidenciando cauda longa."}
...
![](assets/aula12-permutacao/ecdf-exposicoes.png){fig-alt="Curvas acumuladas do total de exposições para anúncio e PSA quase sobrepostas."}
...
![](assets/aula12-permutacao/balanceamento-dia.png){fig-alt="Barras mostrando composição percentual por dia semelhante nos grupos anúncio e PSA."}
...
![](assets/aula12-permutacao/conversao-dia.png){fig-alt="Linhas de conversão por dia para anúncio e PSA, com anúncio acima do PSA."}
...
![](assets/aula12-permutacao/diferenca-hora.png){fig-alt="Barras da diferença de conversão por hora, com variação entre estratos."}
...
![](assets/aula12-permutacao/poder-tamanho.png){fig-alt="Curvas aproximadas de poder para três diferenças de conversão e tamanhos amostrais crescentes."}
