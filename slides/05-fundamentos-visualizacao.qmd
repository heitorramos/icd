...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">ICD: Aula 05 — Fundamentos de visualização</span><a class="lecture-footer-button" href="../aulas/05-fundamentos-visualizacao.html">voltar para a Aula</a>'
execute:
  echo: true
---
