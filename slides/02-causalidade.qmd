...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">ICD: Aula 02 — Causa e efeito</span><a class="lecture-footer-button" href="../aulas/02-causalidade.html">voltar para a Aula</a>'
execute:
  echo: false
---
...
## Desenho do experimento {.experiment-diagram-large}

```{mermaid}
%%| fig-width: 13
%%| fig-height: 6
%%{init: {"themeVariables": {"fontSize": "26px"}, "flowchart": {"nodeSpacing": 54, "rankSpacing": 58, "useMaxWidth": true}}}%%
flowchart LR
  A["Turma"] --> B["Sorteio"]
  B --> C["Controle"]
  B --> D["Lembrete"]
...
::: {.columns .john-snow-introduction}
::: {.column width="45%"}
![](assets/original/john-snow-portrait.jpg){.john-snow-portrait fig-alt="Retrato fotográfico do médico inglês John Snow, sentado e vestindo traje escuro."}

<p class="image-credit">John Snow, c. 1856. Wikimedia Commons, domínio público.</p>
:::
...
::: notes
Retrato: “John Snow (cropped).jpg”, Wikimedia Commons, domínio público.
https://commons.wikimedia.org/wiki/File:John_Snow_(cropped).jpg
:::
...
## Desenhando a confusão {.confounding-diagram-large}
