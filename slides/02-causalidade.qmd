...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">Introdução à Ciência de Dados: Aula 02 — Causa e efeito</span><a class="lecture-footer-button" href="../aulas/index.html">Aulas</a>'
execute:
  echo: false
---
