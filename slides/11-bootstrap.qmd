---
title: "Bootstrap"
subtitle: "Aula 11 — Incerteza a partir de uma única amostra"
...
![](assets/aula11-bootstrap/anuncios-distrito.png){fig-alt="Barras com o número de anúncios por distrito de Nova York, destacando Manhattan e Brooklyn como os maiores grupos."}
...
![](assets/aula11-bootstrap/distribuicao-precos.png){fig-alt="Dois histogramas dos preços dos anúncios Airbnb, em escala original e logarítmica, mostrando forte assimetria à direita."}
...
![](assets/aula11-bootstrap/precos-distrito.png){fig-alt="Boxplots de preço por noite nos cinco distritos de Nova York, sem exibir pontos extremos."}
...
![](assets/aula11-bootstrap/composicao-tipo.png){fig-alt="Barras empilhadas com a composição dos anúncios de Manhattan e Brooklyn por tipo de acomodação."}
...
![](assets/aula11-bootstrap/ecdf-amostra.png){fig-alt="Curvas de distribuição acumulada dos preços de acomodações inteiras em Brooklyn e Manhattan, com as medianas marcadas."}
...
![](assets/aula11-bootstrap/reamostragem-reposicao.png){fig-alt="Pontos representando uma amostra de preços e uma reamostragem bootstrap com valores repetidos e ausentes."}
...
![](assets/aula11-bootstrap/uma-replica.png){fig-alt="Medianas observadas e medianas de uma réplica bootstrap em Brooklyn e Manhattan."}
...
![](assets/aula11-bootstrap/distribuicao-bootstrap.png){fig-alt="Histograma de três mil diferenças bootstrap entre as medianas de Manhattan e Brooklyn."}
...
![](assets/aula11-bootstrap/intervalo-percentil.png){fig-alt="Densidade bootstrap da diferença de medianas com o intervalo percentil de 95 por cento destacado entre 30 e 51 dólares."}
...
![](assets/aula11-bootstrap/estabilidade-b.png){fig-alt="Limites inferior e superior do intervalo bootstrap conforme cresce o número de réplicas."}
...
![](assets/aula11-bootstrap/tamanho-largura.png){fig-alt="Boxplots da largura do intervalo bootstrap para diferentes tamanhos de amostra por distrito."}
...
![](assets/aula11-bootstrap/metodos-intervalo.png){fig-alt="Comparação dos intervalos percentil, básico e Normal para a diferença de medianas."}
...
![](assets/aula11-bootstrap/cobertura-bootstrap.png){fig-alt="Vinte intervalos bootstrap obtidos de amostras repetidas, comparados à diferença de medianas na população didática."}
...
![](assets/aula11-bootstrap/dependencia-host.png){fig-alt="Distribuição do número de anúncios por anfitrião e comparação entre bootstrap por anúncio e por anfitrião."}
