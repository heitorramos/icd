...
subtitle: "Aula 08 — Perda, risco, viés e variância"
...
Na Aula 07, caracterizamos um estimador por sua distribuição amostral:
...
![](assets/aula07-estimadores/perda-assimetrica.png){fig-alt="Comparação entre uma perda quadrática simétrica e uma perda que penaliza subestimações três vezes mais."}
...
![](assets/aula07-estimadores/funcoes-perda.png){fig-alt="Duas curvas de perda: o erro quadrático atinge o mínimo na média e o erro absoluto atinge o mínimo na mediana."}
...
![](assets/aula07-estimadores/robustez-outlier.png){fig-alt="Linhas mostrando a média crescendo à medida que um valor extremo aumenta, enquanto a mediana permanece praticamente constante."}
...
![](assets/aula07-estimadores/comparacao-estimadores.png){fig-alt="Curvas de densidade das estimativas produzidas pela média, mediana e média aparada em muitas amostras."}
...
![](assets/aula07-estimadores/vies-variancia-quadrantes.png){fig-alt="Quatro painéis mostrando combinações de baixo e alto viés com baixa e alta variância em torno de um alvo zero."}
...
![](assets/aula07-estimadores/risco-estimadores.png){fig-alt="Barras empilhadas decompondo o erro quadrático esperado em variância e viés ao quadrado para média, mediana e média aparada."}
