...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">ICD: Aula 06 — Visualização — boas práticas</span><a class="lecture-footer-button" href="../aulas/06-boas-praticas-visualizacao.html">voltar para a Aula</a>'
execute:
  echo: true
---
...
![](assets/aula06-visualizacao/contexto-completo.png){.wide-chart fig-alt="Gráfico de barras com título informativo, unidade, tamanho da base e fonte."}

<details class="code-fold"><summary>Código do exemplo</summary>
...
![](assets/aula06-visualizacao/anotacao-direta.png){.wide-chart fig-alt="Série temporal com o ponto máximo anotado diretamente no gráfico."}
...
![](assets/aula06-visualizacao/legenda-rotulo-direto.png){.wide-chart fig-alt="Comparação entre séries identificadas por legenda e por rótulos diretos."}
...
![](assets/aula06-visualizacao/razao-aspecto.png){.wide-chart fig-alt="A mesma série temporal em painéis estreito e largo, produzindo inclinações aparentes diferentes."}
...
![](assets/aula06-visualizacao/sobreposicao-hexbin.png){.wide-chart fig-alt="Dispersão opaca comparada a uma agregação hexbin dos mesmos filmes."}
...
![](assets/aula06-visualizacao/agregacao-granularidade.png){.wide-chart fig-alt="Notas individuais de filmes comparadas à mediana anual e ao intervalo central."}
...
![](assets/aula06-visualizacao/acessibilidade-redundancia.png){.wide-chart fig-alt="Comparação entre identificação apenas por cor e identificação redundante por cor, tipo de linha e rótulo."}
