...
## Aproximação Normal com correção de continuidade {.smaller}

::: {.callout-note title="Correção de continuidade"}
A Binomial só assume valores inteiros, enquanto a Normal é contínua. Ao aproximar
$K$ por uma variável Normal $Y$, usamos

$$K\ge115\quad\Longrightarrow\quad Y\ge114{,}5.$$

A massa do inteiro 115 é representada pelo intervalo de 114,5 a 115,5.
:::
...
![](assets/aula10-tcl-inferencia/binomial-normal.png){fig-alt="Probabilidades da Binomial para número de caras em 30 lançamentos e curva da aproximação Normal."}
