...
subtitle: "Aula 12 — O acaso como modelo nulo"
...
![](assets/aula12-permutacao/tamanho-grupos.png){fig-alt="Barras mostrando 23.524 usuários no controle PSA e 564.577 no tratamento anúncio."}
...
![](assets/aula12-permutacao/conversao-observada.png){fig-alt="Taxas de conversão de 1,79% no PSA e 2,55% no anúncio."}
...
![](assets/aula12-permutacao/uma-permutacao.png){fig-alt="Exemplo pequeno em que resultados permanecem fixos e rótulos A e B são embaralhados."}
...
![](assets/aula12-permutacao/distribuicao-nula.png){fig-alt="Histograma da distribuição nula concentrada em zero e diferença observada de 0,77 ponto percentual na cauda direita."}
...
![](assets/aula12-permutacao/uma-duas-caudas.png){fig-alt="Comparação visual entre região extrema unilateral e bilateral."}
...
![](assets/aula12-permutacao/convergencia-pvalor.png){fig-alt="Curva do valor-p estimado conforme cresce o número de permutações."}
...
![](assets/aula12-permutacao/efeito-absoluto-relativo.png){fig-alt="Comparação entre aumento absoluto de 0,77 ponto percentual e uplift relativo de aproximadamente 43%."}
...
Na Aula 13, a mesma campanha responderá perguntas mais difíceis:
