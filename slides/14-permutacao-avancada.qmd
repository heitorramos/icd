...
O teste aleatorizado clássico é exato para a **nula estrita de Fisher**:
...
Qual afirmação descreve a nula estrita de Fisher?
...
- [$Y_i(1)=Y_i(0)$ para toda unidade $i$]{.correct data-explanation="A nula estrita afirma ausência de efeito para cada unidade, permitindo imputar todos os resultados potenciais."}
...
- [As distribuições têm apenas a mesma variância]{data-explanation="A nula estrita é uma afirmação sobre resultados potenciais individuais, não apenas dispersão."}

## Nula estrita versus nula média

- **Nula estrita:** permite imputar todos os resultados potenciais e reproduzir exatamente a atribuição.
