...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">Introdução à Ciência de Dados: Aula 14 — Testes de permutação avançados</span><a class="lecture-footer-button" href="../aulas/index.html">Aulas</a>'
execute:
  enabled: false
  echo: false
---
