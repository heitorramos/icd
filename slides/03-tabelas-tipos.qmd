...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: '<span class="lecture-footer-label">ICD: Aula 03 — Tabelas e tipos de dados</span><a class="lecture-footer-button" href="../aulas/03-tabelas-tipos.html">voltar para a Aula</a>'
execute:
  echo: false
---
...
![](assets/aula03-airbnb/valores-ausentes.png){fig-alt="Contagem de valores ausentes em quatro colunas da base Airbnb." width="88%"}
