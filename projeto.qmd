...
- [OpenML](https://www.openml.org/) — plataforma aberta com bases documentadas, tarefas de aprendizado de máquina e resultados experimentais reproduzíveis;
- [Our World in Data](https://ourworldindata.org/) — dados globais documentados sobre saúde, população, economia, energia, ambiente e outros temas;
- [World Bank Open Data](https://data.worldbank.org/) — indicadores internacionais de desenvolvimento, saúde, educação, economia, infraestrutura e meio ambiente;
- [Base dos Dados](https://basedosdados.org/) — bases públicas brasileiras tratadas e padronizadas, adequadas para cruzamentos e análises reproduzíveis;
- [IBGE — SIDRA](https://sidra.ibge.gov.br/) — dados oficiais sobre população, trabalho, renda, produção, preços e território;
- [Microdados do Inep](https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/microdados/microdados-1) — dados de educação, Enem, Enade, Censo Escolar e Educação Superior;
- [Portal de Dados Abertos do TSE](https://dadosabertos.tse.jus.br/pt_BR/) — dados sobre eleições, candidaturas, eleitorado, resultados e prestação de contas;
- [MapBiomas](https://plataforma.brasil.mapbiomas.org/) — dados sobre cobertura e uso da terra, água, agricultura e transformações ambientais;
