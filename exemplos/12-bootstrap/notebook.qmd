...
A distribuição empírica $\widehat F_n$ coloca massa $1/n$ em cada observação. O bootstrap trata essa distribuição como uma aproximação da população e gera amostras de tamanho $n$ com reposição. Para cada amostra calculamos
...
Intervalo percentil não é o único método. Intervalos básico, Normal e BCa fazem correções diferentes e podem discordar, especialmente quando a distribuição bootstrap é assimétrica.
