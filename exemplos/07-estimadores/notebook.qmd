...
subtitle: "Notebook das Aulas 07 e 08"
format:
  html:
    code-fold: true
...
![](../../slides/assets/aula07-estimadores/populacao-massa.png){fig-alt="Distribuição da massa corporal dos pinguins por espécie."}
...
![](../../slides/assets/aula07-estimadores/amostragem-enviesada.png){fig-alt="Comparação entre amostragem aleatória e amostragem restrita a Gentoo."}
...
![](../../slides/assets/aula07-estimadores/funcoes-perda.png){fig-alt="Perdas quadrática e absoluta em função da estimativa."}
