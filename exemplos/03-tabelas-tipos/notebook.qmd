...
Nesta análise (1. Preparação), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (2. Leitura e unidade observacional), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (3. Diagnóstico inicial), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (5. Valores ausentes), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (5. Valores ausentes), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (5. Valores ausentes), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::


**Interpretação:** a ausência parece estrutural. Sem avaliações, não existe
uma “última avaliação”. Preencher a data com zero seria conceitualmente errado.
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (7. Regras de validade), compare centro e dispersão em conjunto: médias, medianas e quantis contam partes diferentes da distribuição e podem divergir quando há assimetria ou valores extremos. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (8. Distribuição do preço), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (8. Distribuição do preço), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Filtros legíveis), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (11. Categorias e contagens), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (11. Categorias e contagens), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (12. Groupby: dividir, aplicar e combinar), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Duas categorias), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Duas categorias), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (13. Encadeamento documentado), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (15. Respostas sugeridas), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (15. Respostas sugeridas), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (18. Tabelas cruzadas e proporções condicionais), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (18. Tabelas cruzadas e proporções condicionais), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (19. Índices hierárquicos e reshape), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Formato largo e formato longo), compare centro e dispersão em conjunto: médias, medianas e quantis contam partes diferentes da distribuição e podem divergir quando há assimetria ou valores extremos. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Erro 1 — usar `and` em Series), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Erro 4 — converter datas silenciosamente), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Plano), esta etapa é uma auditoria inicial: ela não responde ainda à pergunta principal, mas revela tamanho, cobertura, ausências e limitações que condicionam todas as análises seguintes. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Plano), ao discutir a tabela agregada, destaque qual denominador foi usado e qual informação se perdeu ao resumir várias linhas em um único valor. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
...
::: {.callout-note title="Discussão da análise"}
Nesta análise (Plano), a figura deve ser lida antes do resumo numérico: observe forma, assimetria, grupos, valores extremos e escolhas de escala antes de transformar o padrão em uma conclusão. Ao discutir essa saída, conecte sempre o número calculado à unidade observacional da tabela: aqui, linhas, colunas e tipos de variáveis definem quais perguntas podem ser respondidas sem mudar a granularidade.
:::
